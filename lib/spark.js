...
var errors = {
  ...
  pwm: "PWM is only available on D0, D1, A0, A1, A5, A6, A7"
};
...
Spark.prototype.pinMode = function(pin, mode) {
  ...
  // True PWM (3) is only available on D0, D1, A0-A7
  if (mode === 3) {
    // Set to output, this will route through analogWrite
    sMode = 1;

    // throw if attempting to create a PWM on an incapable pin
